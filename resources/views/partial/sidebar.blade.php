...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#user-manage" aria-expanded="false"
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="master-data">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="/pages/product_types">Product Type</a></li>
                    <li class="nav-item"><a class="nav-link" href="/pages/products">Product</a></li>
                    <li class="nav-item"><a class="nav-link" href="/pages/customers">Customer</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#transaction-data" aria-expanded="false"
               aria-controls="transaction-data">
                <span class="menu-title">Transaction</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
            </a>
            <div class="collapse" id="transaction-data">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="/pages/invoices">Invoice</a></li>
                    <li class="nav-item"><a class="nav-link" href="/pages/payments">Payment</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#distribusi" aria-expanded="false"
            ...
            <div class="collapse" id="distribusi">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="pages/ui-features/buttons.html">MAP POP &
                            Endpoint</a></li>
                    <li class="nav-item"><a class="nav-link" href="pages/ui-features/typography.html">Perangkat & Access
                            Point</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#administrasi" aria-expanded="false"
